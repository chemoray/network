...
<form action="#" method="post" >
    <table border="1" cellspacing="2" bgcolor="#ADD8E6" >
        ...
        <c:forEach items="${checknews}" var="news">
            <tr align="center">
                ...
                <td><a href="../DeleteNewsServlet?id=${news.getId()}&action=admin">删除</a>&nbsp;<a href="../CheckNewsServlet?newsid=${news.getId()}">通过</a>
            </tr>
        </c:forEach>
