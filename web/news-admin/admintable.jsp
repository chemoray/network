...
<body>
	<table border="1" align="center">
		...
		<c:forEach items="${admin_list}" var="adminUser">
			<tr>
				<td style="text-align: center;"><input type="checkbox" value="${adminUser.getId()}" name="adminid"/></td>
				...
				<td style="text-align: center;"><a href="../ShowUpdateAdminServlet?adminid=${adminUser.getId()}">修改</a></td>
			</tr>
		</c:forEach>
	</table>
</body>
