...
<body background="img/skin_/beijing.jpg">
	<form action="../NewsUpdateServlet?action=author" method="post">
		...
		<table align="center">
			...
			<tr>
				<td>新闻类别:</td>
				<td><c:choose>
						<c:when test="${Newsdetail.category_id =='1'}">
						...
						<c:when test="${Newsdetail.category_id == '2' }">
						...
						<c:when test="${Newsdetail.category_id == '3' }">
						...
						<c:when test="${Newsdetail.category_id == '4' }">
						...
						<c:when test="${Newsdetail.category_id == '5' }">
			...
			<tr>
				<td></td>
				<td><c:choose>
						<c:when test="${Newsdetail.category_id == '6' }">
						...
						<c:when test="${Newsdetail.category_id == '7' }">
						...
						<c:when test="${Newsdetail.category_id == '8' }">
						...
						<c:when test="${Newsdetail.category_id == '9' }">
						...
						<c:when test="${Newsdetail.category_id == '10' }">
			...
			<tr>
				...
				<td><input type="text" name="title" value="${Newsdetail.title}"></td>
			</tr>
			<tr>
				<td><p style="line-height: 13px">新闻内容:</p></td>
				<td><textarea style="width: 400px; height: 200px;"
						name="content" >${Newsdetail.content}</textarea></td>
			</tr>
			<%-- <tr>
