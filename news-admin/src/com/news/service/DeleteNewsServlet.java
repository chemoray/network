...
public class DeleteNewsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (update != 0) {
                if(action.equals("admin"))  response.sendRedirect("news-admin/deletenews.jsp");
                if(action.equals("author"))  response.sendRedirect("news-author/authordeletenews.jsp?authorid="+author);
            }else {
                String msg = "error";
